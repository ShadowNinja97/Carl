...
public class DeveloperScreenshot : MonoBehaviour
{
    ...
    void Update()
    {
        if (Input.GetKeyDown(KeyBinds.screenshot))
        { // capture screen shot on left mouse button down

            string folderPath = "Assets/Project/Assets/Screenshots/"; // the path of your project folder
